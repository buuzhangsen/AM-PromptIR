...
parser.add_argument('--denoise_dir', type=str, default='/data/data/Train/denoise',
                    help='where clean images of denoising saves.')
parser.add_argument('--derain_dir', type=str, default='/data/data/Train/derain',
                    help='where training images of deraining saves.')
parser.add_argument('--dehaze_dir', type=str, default='/data/data/Train/dehazy',
...
parser.add_argument("--wblogger",type=str,default="am-promptir",help = "Determine to log to wandb or not and the project name")
