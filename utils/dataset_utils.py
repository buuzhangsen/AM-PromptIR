...
class PromptTrainDataset(Dataset):
    ...
    def _init_clean_ids(self):
        ...
        clean_ids += [self.args.denoise_dir + id_ for id_ in temp_ids ]
    ...
    def _get_gt_name(self, rainy_name):
        ...
        gt_name = rainy_name.replace("low", "high")
    ...
    def __getitem__(self, idx):
        ...
        if de_id < 3:
            if de_id == 0:
                ...
                class_name = 'denoise_15'
            elif de_id == 1:
                clean_id = sample["clean_id"]
                class_name = 'denoise_25'
            elif de_id == 2:
                clean_id = sample["clean_id"]
                class_name = 'denoise_50'
        ...
        return [clean_name, de_id], degrad_patch, clean_patch,class_name
...
class DenoiseTestDataset(Dataset):
    ...
    def _add_gaussian_noise(self, clean_patch):
        ...
        if self.sigma ==50:
            class_name = 'denoise_50'
        return noisy_patch, clean_patch,class_name
    ...
    def __getitem__(self, clean_id):
        ...
        noisy_img, _,class_name = self._add_gaussian_noise(clean_img)
        clean_img, noisy_img = self.toTensor(clean_img), self.toTensor(noisy_img)
        return [clean_name], noisy_img, clean_img , class_name
...
class DerainDehazeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        class_name = self.task
        return [degraded_name], degraded_img, clean_img,class_name
